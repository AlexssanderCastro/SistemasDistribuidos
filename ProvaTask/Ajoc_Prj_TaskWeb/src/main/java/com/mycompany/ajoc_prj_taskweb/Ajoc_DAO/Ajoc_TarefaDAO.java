...
public class Ajoc_TarefaDAO {
    ...
    public void Ajoc_salvar(Ajoc_Tarefa Ajoc_t) throws SQLException {
        ...
        try (PreparedStatement Ajoc_ps = Ajoc_conn.prepareStatement(Ajoc_sql)) {
            ...
            Ajoc_ps.setDate(5, Ajoc_t.getAjoc_data_inicio() != null
                    ? Ajoc_ManipulaData.Ajoc_getInstancia().Ajoc_string2Date(Ajoc_t.getAjoc_data_inicio()) : null);
            Ajoc_ps.setDate(6, Ajoc_t.getAjoc_data_fim() != null
                    ? Ajoc_ManipulaData.Ajoc_getInstancia().Ajoc_string2Date(Ajoc_t.getAjoc_data_fim()) : null);
    ...
    public List<Ajoc_Tarefa> Ajoc_listar() throws SQLException {
        ...
        String Ajoc_sql = "SELECT t.ajoc_id_tarefa , t.ajoc_nome AS tarefa_nome,t.ajoc_descricao AS tarefa_descricao,t.ajoc_prioridade,t.ajoc_data_inicio,t.ajoc_data_fim AS tarefa_data_fim,p.ajoc_id_projeto ,p.ajoc_nome AS projeto_nome, p.ajoc_descricao AS projeto_descricao,p.ajoc_data_criacao, p.ajoc_data_fim AS projeto_data_fim FROM ajoc_tarefa t LEFT JOIN ajoc_projeto p ON p.ajoc_id_projeto = t.ajoc_id_projeto";
        ...
        try (PreparedStatement Ajoc_ps = Ajoc_conn.prepareStatement(Ajoc_sql); ResultSet Ajoc_rs = Ajoc_ps.executeQuery()) {
            ...
            while (Ajoc_rs.next()) {
                ...
                Ajoc_t.setAjoc_titulo(Ajoc_rs.getString("tarefa_nome"));
                Ajoc_t.setAjoc_descricao(Ajoc_rs.getString("tarefa_descricao"));
                Ajoc_t.setAjoc_prioridade(Ajoc_rs.getString("ajoc_prioridade"));

                Timestamp Ajoc_inicio = Ajoc_rs.getTimestamp("ajoc_data_inicio");
                Timestamp Ajoc_fim = Ajoc_rs.getTimestamp("tarefa_data_fim");
                Ajoc_t.setAjoc_data_inicio(
                        Ajoc_inicio != null ? Ajoc_ManipulaData.Ajoc_getInstancia().Ajoc_date2String(Ajoc_inicio.toString()) : null
                );
                Ajoc_t.setAjoc_data_fim(
                        Ajoc_fim != null ? Ajoc_ManipulaData.Ajoc_getInstancia().Ajoc_date2String(Ajoc_fim.toString()) : null
                );

                Ajoc_Projeto Ajoc_p = new Ajoc_Projeto();
                Ajoc_p.setAjoc_id((UUID) Ajoc_rs.getObject("ajoc_id_projeto"));
                Ajoc_p.setAjoc_nome(Ajoc_rs.getString("projeto_nome"));
                Ajoc_p.setAjoc_descricao(Ajoc_rs.getString("projeto_descricao"));

                Timestamp Ajoc_criacao = Ajoc_rs.getTimestamp("ajoc_data_criacao");
                Timestamp Ajoc_data_fim_proj = Ajoc_rs.getTimestamp("projeto_data_fim");
                Ajoc_p.setAjoc_data_criacao(
                        Ajoc_criacao != null ? Ajoc_ManipulaData.Ajoc_getInstancia().Ajoc_date2String(Ajoc_criacao.toString()) : null
                );
                Ajoc_p.setAjoc_data_fim(
                        Ajoc_data_fim_proj != null ? Ajoc_ManipulaData.Ajoc_getInstancia().Ajoc_date2String(Ajoc_data_fim_proj.toString()) : null
                );
        ...
        try (PreparedStatement Ajoc_ps = Ajoc_conn.prepareStatement(Ajoc_sql)) {
            ...
            try (ResultSet Ajoc_rs = Ajoc_ps.executeQuery()) {
                if (Ajoc_rs.next()) {
                    ...
                    Ajoc_t.setAjoc_data_inicio(Ajoc_inicio != null ? Ajoc_ManipulaData.Ajoc_getInstancia().Ajoc_date2String(Ajoc_inicio.toString()) : null);
                    Ajoc_t.setAjoc_data_fim(Ajoc_fim != null ? Ajoc_ManipulaData.Ajoc_getInstancia().Ajoc_date2String(Ajoc_fim.toString()) : null);
                    ...
                    Ajoc_p.setAjoc_data_fim(Ajoc_data_fim_proj != null ? Ajoc_ManipulaData.Ajoc_getInstancia().Ajoc_date2String(Ajoc_data_fim_proj.toString()) : null);
